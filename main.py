...
from broadlink import discover as bl_discover  # https://github.com/mjg59/python-broadlink
...
class MIDIClockReceiver:
	...
	def __init__(self, bpm=None, device=None):
		self.device = device
		self.cycle = [self.pkt_100_pc, self.pkt_60_pc, self.pkt_30_pc]  # , pkt_chg_ptrn]
		self.cycle_ctr = 0
